...
assignment_type_hashes = [
  ...
  { :name => 'Creative', :predictor_display => 'Slider' }
]
predictor_description = ['We will work to build a learning community, and I want this to be a great learning experience for all. To do this requires that you commit to the class and participate.','As much money and life as you could want!  The two things most human beings would choose above all - the trouble is, humans do have a knack of choosing precisely those things that are worst for them.','It is our choices that show what we truly are, far more than our abilities.','Happiness can be found, even in the darkest of times, if one only remembers to turn on the light.']
