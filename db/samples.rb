...
badge_icons = ['/assets/badges/above_and_beyond.png','/assets/badges/always_learning.png','/assets/badges/awesome_aggregator.png','/assets/badges/concentrator.png','/assets/badges/courageous_failure.png','/assets/badges/early_bird_special.png','/assets/badges/examination_expert.png','/assets/badges/gaining_experience.png','/assets/badges/gamer.png','/assets/badges/great_critic.png','/assets/badges/learning_from_mistakes.png','/assets/badges/level_one.png','/assets/badges/participatory_democrat.png','/assets/badges/personal.png','/assets/badges/practice_makes_perfect.png','/assets/badges/presentation_of_self.png','/assets/badges/public_speaker.png']
