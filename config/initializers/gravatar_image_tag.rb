...
GravatarImageTag.configure do |config|
  ...
  config.filetype                = 'png'   # Set this if you require a specific image file format ['gif', 'jpg' or 'png'].  Gravatar's default is png
  ...
  config.size                    = 250   # Set this to globally set the size of the gravatar image returned (1..512). Gravatar's default is 80
