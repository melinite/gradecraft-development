class GradeSchemeElementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @grade_scheme_element.save
        format.html { redirect_to grade_scheme_elements_path, notice: 'Grade Scheme was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to grade_scheme_element_path(@grade_scheme_element), notice: 'Grade Scheme was successfully deleted.' }
      format.json { head :ok }
    end
  end
end
